...
async function setupCoreProtocol(config) {
    const addr = await config.vaultFactory.createNewMarket(5, config.dai_addr, 99000000, 1694094186, 1694126606, config.aggregator_addr, "y2kWETH_99*JUNE");
    hedgeVault_addr = addr[0];
    riskVault_addr = addr[1];
}
